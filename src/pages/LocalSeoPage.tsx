...
export const LocalSeoPage: React.FC = () => {
  ...
  const service = SERVICES_DATA['local-seo'];

  const rankingFactors = [
    { title: 'Google Business Profile Signals', desc: 'Primary & secondary category precision, keyword-optimized business descriptions, and active weekly updates.' },
    { title: 'Citation & NAP Consistency Signals', desc: 'Exact Name, Address, and Phone number matching across high-authority regional and industry directories.' },
    { title: 'On-Page Local Signals', desc: 'Localized H1 and title tags, embedded Google Maps, geo-coordinates, and LocalBusiness JSON-LD schema.' },
    { title: 'Review Velocity & Sentiment Signals', desc: 'Authentic customer review acquisition cadence, average star rating, and owner review response rates.' },
    { title: 'Localized Backlink Signals', desc: 'Local chamber of commerce mentions, city business spotlights, and local supplier resource links.' },
    { title: 'Behavioral & Proximity Signals', desc: 'Click-to-call rates, driving direction requests, and mobile check-in engagement patterns.' },
  ];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center mb-14">
            ...
            <p className="text-sm sm:text-base text-slate-600">
              Capture nearby customers actively seeking your services in your immediate geographic radius.
            </p>
          </div>
      ...
      <section className="py-16 sm:py-20 bg-white border-b border-slate-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center mb-14">
            ...
            <h2 className="text-2xl sm:text-4xl font-extrabold text-slate-900 tracking-tight mb-4">
              The 6 Core Local Search Ranking Signals
            </h2>
            <p className="text-sm sm:text-base text-slate-600">
              Ranking in Google Maps 3-Pack requires continuous synchronization across these operational pillars.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {rankingFactors.map((factor, idx) => (
              <div key={idx} className="p-6 rounded-2xl bg-slate-50 border border-slate-200 shadow-sm">
                <div className="w-8 h-8 rounded-lg bg-blue-50 text-blue-600 font-bold text-xs flex items-center justify-center mb-3 border border-blue-200">
                  0{idx + 1}
                </div>
      ...
      <section className="py-16 bg-slate-50/60 border-b border-slate-200 text-center">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-sm text-slate-600 max-w-xl mx-auto mb-8">
            Check your Google Business Profile rank and local citation consistency across your target city.
          </p>
          <button
            type="button"
            onClick={() => navigate('/free-seo-audit/')}
          ...
          >
            ...
            <span>Request Your Local 3-Pack Audit</span>
          </button>
        </div>
      </section>
